...
- Vercel:
  Settings -> Build & Deployment Settings -> Project Settings - > Override build command (for sass -> css files) and Output directory (/)

- On future changes, commit and push to Github, Vercel automatically uploads new changes.
